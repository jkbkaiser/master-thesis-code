...
from src.experiments.bioscan_baselines.lighting import LightningGBIF
...
def parse_args():
    ...
    parser.add_argument(
        "--experiment-name", default="clibdb_baselines", required=False, type=str
    )
...
def run(args):
    ds = BioscanDataset(args.dataset)
